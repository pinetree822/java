...
If you want clearer vision for "something" in java, you need to start defining the boundary of that "something". 

In Java the ideal choice is the Class.


Start by refactoring your code to separate what you consider the "Protocol" into a "Protocol" class. 

Later on, if you find that you want to support more than one "Protocol" write a second "ProtocolTwo" class, 

rename the "Protocol" class to something like "ProtocolOne" and make a common shared interface between the two called "Protocol".
...
Of course, it is homework, so you'll get the joy of putting all the important bits into the right places. 

Good luck, and post back as you get closer to the goal.
