...
//	private static final String SERVER_IP = "192.168.219.198";
	...
	public void Login() {
		...
		Login_f.setBounds(100, 100, 1000, 800);
		...
		lblNewLabel.setBounds(113, 250, 57, 15);
...
//		ip_tf = new JTextField("192.168.219.198");
		...
		ip_tf.setBounds(181, 250, 116, 21);
		panel.add(ip_tf);
		ip_tf.setColumns(10);

		lblNewLabel_1 = new JLabel("ID :");	// 아이디 레이블
		lblNewLabel_1.setBounds(113,300, 57, 15);
		...
		id_tf.setBounds(181, 300, 116, 21);
		panel.add(id_tf);
		id_tf.setColumns(10);
	...
	public void Chatmain(String id, ImageIcon frofile) {
		...
		Chatmain_f.setBounds(100, 100, 1000, 800);					// 패널 크기,위치
//		Chatmain_f.setBounds(100, 100, 546, 378);					// 패널 크기,위치
		...
		panel_2.setBounds(800, 10, 154, 276);
...
//		UserCount_Label.setText(sock.si);
		...
		textArea.setBounds(0, 0, 600, 700);
		scrollPane = new JScrollPane();
		scrollPane.setViewportView(textArea);
		scrollPane.setBounds(12, 10, 600, 700);
