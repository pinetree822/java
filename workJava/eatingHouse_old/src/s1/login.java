...
public class login extends JFrame {
	...
	public login() {
		...
		JButton bt_log_submit = new JButton("\uD68C\uC6D0\uC811\uC18D");
		bt_log_submit.setBounds(53, 154, 97, 23);
		log_main.add(bt_log_submit);
		
		JButton bt_log_cancel = new JButton("\uCDE8\uC18C");
		bt_log_cancel.setBounds(175, 154, 97, 23);
		log_main.add(bt_log_cancel);
