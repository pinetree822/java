...
public class member_register extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					member_register frame = new member_register();
	...
	public member_register() {
		...
		JLabel lbl_4 = new JLabel("\uD68C\uC6D0\uC8FC\uC18C");
		
		JLabel lbl_3 = new JLabel("\uC804\uD654\uBC88\uD638");
		
		JLabel lbl_6 = new JLabel("\uD68C\uC6D0\uC18C\uAC1C");
		
		JTextArea ta_1 = new JTextArea();
		ta_1.setLineWrap(true);
		
		JLabel lbl_9 = new JLabel("\uD68C\uC6D0\uC885\uB958");
		
		tf_9 = new JTextField();
		tf_9.setColumns(10);
		GroupLayout gl_cPane_1 = new GroupLayout(cPane_1);
		gl_cPane_1.setHorizontalGroup(
			gl_cPane_1.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_cPane_1.createSequentialGroup()
					.addGap(236)
